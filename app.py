...
img_contact_form = Image.open("image/IMG-20211212-WA0005.jpg")
img_lottie_animation = Image.open("image/IMG-20211212-WA0002.jpg")
# Header Section
with st.container():
...
with st.container():
    ...
    with text_column:
        ...
        st.write(
            ...
            because python lenguage is very simple and easy to understand.
